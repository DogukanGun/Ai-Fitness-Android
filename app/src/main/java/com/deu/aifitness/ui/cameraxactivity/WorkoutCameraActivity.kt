...
class WorkoutCameraActivity : AIFitnessActivity<WorkoutCameraVM,ActivityWorkoutCameraBinding>(){
     ...
     * 3 == PoseNet model
     **/
    private var modelPos = 0 // model değiştirmek için burdan yukarıdaki parametreleri ver default:1, 0 ve 3 daha iyi fps verir. -alper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workout_camera)
        setAppBar()
